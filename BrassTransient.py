# Brass simulation with init_func to start at 27 °C and capped colorbar
...
# --------------------------
# Physical and material parameters for Brass (Cartridge)
# --------------------------
...
# --------------------------
# Plot setup with colorbar from 27°C to 500°C
# --------------------------
...
output_path = Path.cwd() / "thermal_clip_brass_capped27_init.gif"
